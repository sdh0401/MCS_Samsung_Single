                    ...
                    if ( *(p+1) == '#' ) {
                        ...
                        for( int i = 0; i < NUM_ENTITIES; ++i ) {
                            ...
                            if ( strncmp( p + 1, entity.pattern, entity.length ) == 0
                                ...
                                *q = entity.value;
                                ++q;
                                p += static_cast<size_t>(entity.length) + 2;
                                entityFound = true;
                                break;
                            }
                        }
...
const char* XMLDocument::_errorNames[static_cast<size_t>(XMLError::XML_ERROR_COUNT)] = {
    "XML_SUCCESS",
    "XML_NO_ATTRIBUTE",
...
/*static*/ const char* XMLDocument::ErrorIDToName(XMLError errorID)
{
    ...
    if (errorID < XMLError::XML_SUCCESS || errorID >= XMLError::XML_ERROR_COUNT)
        return "Unknown Error";
    const char* errorName = _errorNames[static_cast<size_t>(errorID)];
