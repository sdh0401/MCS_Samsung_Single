...
public:
    ...
    */
    ...
    // internal:
    enum class ElementClosingType : int {
        OPEN,		// <foo>
        CLOSED,		// <foo/>
        CLOSING		// </foo>
    };
...
private:
	...
	static const char* _errorNames[static_cast<size_t>(XMLError::XML_ERROR_COUNT)];
