...
class CStartOffsetCamera : public CPowerThread
{
public:
	CStartOffsetCamera();
	CStartOffsetCamera(HANDLE h_Terminate);
	void InitializeValue();
	~CStartOffsetCamera();
	void ClearStep();
	void Run();
	static UINT RunOffsetCameraCalibration(LPVOID wParam);
...
extern CStartOffsetCamera* gcStartOffsetCamera;